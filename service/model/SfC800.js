...
SfC800.prototype.insert = async (dataSfC800) => {
	let sql = `insert into sf_c800 
						...
						values 
						( :nr_chave_cfe, :id_modelo_documento, :id_ref_413, to_date(:dt_documento, 'dd/mm/yyyy'), :nr_cnpj_cpf, :nr_serie_sat, :nr_cfe, :nr_caixa, :nm_destinatario, :vl_desconto, :vl_mercadoria, :vl_outras_desp, :vl_icms, :vl_pis, :vl_pis_st, :vl_cofins, :vl_cofins_st, :vl_cfe, :id_empresa, :id_usuario)
						`;
	try {
